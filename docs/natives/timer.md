...
- `debounce<Args extends unknown[], Ret>(callback: (...args: Args) => Ret, waitFor: number): (...args: Args) => void`
- `sleep(ms: number): Promise<void>`
- `throttle<Args extends unknown[], Ret>(callback: (...args: Args) => Ret, waitFor: number): (...args: Args) => Promise<Awaited<Ret>>`
